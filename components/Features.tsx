    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white p-6 shadow-lg rounded-lg">
          ...
          <p>Evite deslizes gramaticais que podem comprometer sua nota.</p>
        </div>
        <div className="bg-white p-6 shadow-lg rounded-lg">
          <h3 className="text-xl font-bold mb-2">Estrutura Impecável</h3>
          <p>Organize sua redação de forma lógica, fluida e envolvente.</p>
        </div>
        <div className="bg-white p-6 shadow-lg rounded-lg">
          <h3 className="text-xl font-bold mb-2">Propostas de Intervenção</h3>
          <p>Desenvolva soluções criativas e viáveis para os temas apresentados.</p>
        </div>
      </div>
    </div>
  </section>
